...
contextBridge.exposeInMainWorld('tingxie', {
  ...
  showMediaItem: (id: string): Promise<boolean> => ipcRenderer.invoke('library:show-item', id),
  ...
  moveTranscripts: (ids: string[], folderId?: string): Promise<TranscriptSummary[]> => ipcRenderer.invoke('history:move-many', { ids, folderId }),
